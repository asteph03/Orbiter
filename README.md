...
A granulator is an audio plugin — a software component that runs inside a **Digital Audio Workstation (DAW)** such as Ableton Live, Avid Pro-Tools, Reaper, or Logic Pro. It applies **granular synthesis** to any incoming audio signal in real time, slicing it into tiny fragments called grains and reassembling them to create new soundscapes.
